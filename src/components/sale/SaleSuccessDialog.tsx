    ...
    try {
      ...
      setTimeout(async () => {
        try {
          ...
          toast.success(result.path ? `Bill saved to: ${result.path}` : 'Bill image saved!', { description: '📂 Documents/AmeerAutos/', action: { label: '📂 Open Folder', onClick: () => openFileManager() } });
        } catch {
